...
run_fun <- function (expression, start_id = NULL, groups_id = NULL, method = "VEM", 
    num_topics_lower = NULL, num_topics_upper = NULL, num_topics = 4, 
    sd_filter = 0.5, tot_iter = 1e+06, tolerance = 1e-05, absolute_width = 0, 
