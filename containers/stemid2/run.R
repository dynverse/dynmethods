...
run_fun <- function (expression, clustnr = 30, bootnr = 50, metric = "pearson", 
    ...
    dimred_method = "tsne", outminc = 0, outlg = 2, probthr = -10, 
    thr_lower = -40, thr_upper = -1, outdistquant = 0.95, nmode = FALSE, 
    pdishuf = 6.21460809842219, pthr = -2, pethr = -2) 
{
    ...
    sc <- sc %>% StemID2::findoutliers(outminc = 5, outlg = outlg, 
        probthr = probthr, thr = 2^(thr_lower:thr_upper), outdistquant = outdistquant)
