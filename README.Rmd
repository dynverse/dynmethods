    ...
    `Authors` = map_chr(authors, function(authors) {
      map_chr(authors, function(author) {
        ...
        if (!is.null(author$ORCID)) {
          author_text <- glue::glue("{author_text} <a href='https://orcid.org/{author$ORCID}'><img src='https://members.orcid.org/sites/default/files/vector_iD_icon.svg' height='16'></a>")
        }
        
        if (!is.null(author$github)) {
          author_text <- glue::glue("{author_text} <a href='https://github.com/{author$github}'><img src='https://assets-cdn.github.com/images/modules/logos_page/GitHub-Mark.png' height='16'></a>")
        }
