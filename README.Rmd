...
Nearly all methods are integrated within a docker container, avoiding dependency issues. Some methods are also directly wrapped inside of R.
...
df2 <- df %>% 
  select(
    `Method`,
    Wrapper, 
    `<a href='https://github.com/dynverse/dynmethods/tree/master/R'><img src='man/figures/r_logo.png' height='40'></a>` = `R wrapper`, 
    `<a href='https://hub.docker.com/u/dynverse/'><img src='man/figures/docker_logo.png' height='40'></a>` = `Docker container`,
    `Authors`
  )
