...
In some cases, we already provide functions which do the calculation of milestone_percentages or progressions under the hood. For example, when a method returns only a pseudotime:
