...
#' 
#' Will generate a trajectory using [CellRouter](https://doi.org/10.1038/s41467-018-03214-y). This method was wrapped in a [docker](https://github.com/dynverse/dynmethods/tree/master/containers/cellrouter).
#' 
...
#'     integer; default: 20; possible values between 2 and 100
#' @param ndim_tsne Number of tsne dimensions to compute \cr 
#'     integer; default: 11; possible values between 2 and 100
#' @param max_iter Maximal number of tsne iterations \cr 
#'     integer; default: 1000; possible values between 100 and 100000
...
#'     integer; default: 20; possible values between 2 and 1000
...
#'     integer; default: 10; possible values between 2 and 1000
...
#'     integer; default: 3; possible values between 3 and 100
#' @param neighs The size of the neighborhood in kNN graph used to smoothen kinetic profiles \cr 
#'     integer; default: 3; possible values between 2 and 100
#' 
