...
#' @title Inferring a trajectory inference using StemID2
#' 
#' @description
#' Will generate a trajectory using
#' [StemID2](https://doi.org/10.1016/j.stem.2016.05.010).
#' 
#' This method was wrapped inside a
#' [container](https://github.com/dynverse/dynmethods/tree/master/containers/stemid2).
#' The original code of this method is available
#' [here](https://github.com/dgrun/RaceID3_StemID2).
#' 
...
ti_stemid2 <- function(
  ...
  create_container_ti_method(
    docker_repository = "dynverse/stemid2",
