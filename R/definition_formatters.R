generate_file_from_definition <- function(definition) {
  paste0(
    # header
    "######################################## DO NOT EDIT! ########################################\n",
    "#### This file is automatically generated from data-raw/generate_r_code_from_containers.R ####\n",
    "##############################################################################################\n",
    "\n",
...
generate_function_from_definition <- function(definition) {
  ...
  # use docker repository defined by definition, if available
  docker_repository <-
    if (!is.null(definition$docker_repository)) {
      definition$docker_repository
    } else {
      paste0("dynverse/", definition$short_name)
    }

  # return code for function
  paste0(
    "ti_", definition$short_name, " <- function(\n",
    parameters, "\n",
    ") {\n",
    "  create_ti_method(\n",
