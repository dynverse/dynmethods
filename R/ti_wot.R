...
#' @title Inferring a trajectory inference using Waddington-OT
#' 
#' @description
#' Will generate a trajectory using
#' [Waddington-OT](https://doi.org/101010101/1101010101).
#' 
#' This method was wrapped inside a
#' [container](https://github.com/dynverse/dynmethods/tree/master/containers/wot).
...
ti_wot <- function(
  ...
  create_container_ti_method(
    docker_repository = "dynverse/wot",
