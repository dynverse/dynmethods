...
#' @title Inferring a trajectory inference using ElPiGraph cycle
#' 
#' @description
#' Will generate a trajectory using [ElPiGraph
#' cycle](https://github.com/Albluca/ElPiGraph.R).
#' 
#' This method was wrapped inside a
#' [container](https://github.com/dynverse/ti_elpicycle).
#' The original code of this method is available
#' [here](https://github.com/Albluca/ElPiGraph.R).
#' 
#' 
#' 
#' @param topology discrete; The kind of topology to detect (default: `"cycle"`;
#' values: {`"cycle"`})
