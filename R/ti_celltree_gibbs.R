...
#' 
#' @param method Parameter; LDA inference method to use., Domain: {Gibbs},
#' Default: Gibbs, Format: character.
...
#' U(2, 15), Default: 4, Format: integer.
#' @param tot_iter Parameter; Numeric parameters (optional) forwarded to the
#' chosen LDA inference method's contol class., Domain: e^U(2.30, 6.91), Default:
#' 200, Format: numeric.
...
ti_celltree_gibbs <- function(
  ...
  create_ti_method_container(
    container_id = "dynverse/ti_celltree_gibbs:v0.9.9",
  )(
    method = method,
    sd_filter = sd_filter,
